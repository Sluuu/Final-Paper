...
The model is set up by using R [@citeR] with the help of the following packages, `tidyverse` package of @tidyverse, `readr` package of @readr, `dplyr` package of @dplyr, `dataverse` package of @dataverse
