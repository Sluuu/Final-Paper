...
In this paper, I am interested on how global crises impact each country differently. I have chosen the top two global crisis as my study, which are the 2008, 09 global financial crisis and the 2020 COVID-19 pandemic. 
```{r}
#| echo: false
#| warning: false
#| message: false
...
In @fig-data, I have presented the relationship between GDP growth and Inflation of each countries from my data-set. Which each dot represents one country.
